...
class Adm extends CI_Controller
{
	...
	public function kartupeserta()
	{
		...
		foreach ($data as $load) {
			...
			$pdf->Cell(0.1, 3, '', 1, 0);
			$pdf->Cell(13.9, 3, '', 0, 0);
			$pdf->Cell(49, 3, 'Nbam. ' . $nip_kepala, 0, 0);
			$pdf->Cell(0.1, 3, '', 1, 1);
	...
	public function m_ruangan()
	{
		...
		if ($uri3 == "det") {
			...
			$pdf->Cell(50, 5, 'Nbam.', 0, 0, 'L');
			$pdf->Cell(50, 5, 'Nbam.', 0, 1, 'L');
	...
	public function m_ujian()
	{
		...
		if ($uri3 == "det") {
			...
			if ($uri4 != '') {
				...
				$pdf->Cell(30, 5, 'Guru', 0, 0, 'L');
				$pdf->Cell(50, 5, '....................', 'B', 0, 'L');
				$pdf->Cell(10, 5, '1. ', 0, 0, 'R');
				$pdf->Cell(50, 5, '', 'B', 1, 'L');
				$pdf->Cell(10, 5, '', 0, 0, 'L');
				$pdf->Cell(30, 5, 'Nbam.', 0, 0, 'L');
				$pdf->Cell(50, 5, '', 'B', 1, 'L');
