...
function m_guru_u(id) {
  if (swal({
    title: "Apakah Anda Yakin?",
    text: "Aktifkan akun ini! Username dan Password adalah Nbam!",
    icon: "info",
    buttons: ["Batal", "Oke, Aktifkan!"],
    dangerMode: true,
    }).then((willDelete) => {
...
function m_guru_ur(id) {
  if (swal({
    title: "Apakah Anda Yakin?",
    text: "Reset akun ini! Username dan Password adalah Nbam!",
    icon: "info",
...
function aktifkan_semua_guru() {
  if (swal({
    title: "Apakah Anda Yakin?",
    text: "Akun Guru akan diaktifkan semua!",
    icon: "info",
    buttons: ["Batal", "Oke, Aktifkan!"],
    dangerMode: true,
    }).then((willDelete) => {
